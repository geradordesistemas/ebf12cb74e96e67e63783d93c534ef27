...
namespace App\Application\Project\SecurityAdminBundle\Command;
...
#[AsCommand(
    ...
    description: 'Cria um novo usuario administrador!',
)]
class CreateAdminUserCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $user = $em->getRepository(UserAdmin::class)->findOneBy(['email'=>$email]);
        if($user){
        ...
        $user->setAdminRoles(['ROLE_SUPER_ADMIN']);
