...
#[ACL\Admin(enable: true, title: 'Grupo Administrador', description: 'Permissões do modulo Grupo Administrador')]
class GroupAdminAdminController extends BaseAdminController
{
