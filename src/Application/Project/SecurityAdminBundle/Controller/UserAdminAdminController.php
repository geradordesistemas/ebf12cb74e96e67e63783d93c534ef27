...
namespace App\Application\Project\SecurityAdminBundle\Controller;
...
#[ACL\Admin(enable: true, title: 'Usuário Administrador', description: 'Permissões do modulo Usuário Administrador')]
class UserAdminAdminController extends BaseAdminController
{
