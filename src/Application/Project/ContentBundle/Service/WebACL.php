...
class WebACL extends BaseACL
{
    private string $acl = 'Web';
    ...
    private function getSuperWebRole(): array
    {
        return [
            "title" => "Super Web",
            "description" => "Tem Acesso a todos os Módulos Web.",
            "controllerName"=> "",
            "controllerNamespace"=> "",
            "routes" => [[
                "router" => "AllActions",
    ...
    public function getWebGroupRoles(): array
    {
        return array_merge([$this->getSuperWebRole()], $this->start());
    }
    ...
    public function getWebRoles(): array
    {
        ...
        return array_merge(['ROLE_SUPER_WEB'], $roles);
    }
