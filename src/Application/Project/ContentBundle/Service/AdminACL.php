...
class AdminACL extends BaseACL
{

    private string $acl = 'Admin';
    ...
    private function getSuperAdminRole(): array
    {
        return [
    ...
    {
        return array_merge([$this->getSuperAdminRole()], $this->start());
    }
    ...
    public function getAdminRoles(): array
    {
        ...
        return array_merge(['ROLE_SUPER_ADMIN'], $roles);
    }
