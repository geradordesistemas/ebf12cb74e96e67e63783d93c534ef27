...
#[Route('/api/tipoCurso', name: 'api_tipoCurso_')]
#[OA\Tag(name: 'TipoCurso')]
#[ACL\Api(enable: true, title: 'TipoCurso', description: 'Permissões do modulo TipoCurso')]
class TipoCursoApiController extends BaseApiController
{
    ...
    /** ****************************************************************************************** */
    /**
     * Recupera a coleção de recursos — TipoCurso.
     * Recupera a coleção de recursos — TipoCurso.
    ...
    #[OA\Response(
        response: 200,
        description: 'Retorna Coleção de recursos TipoCurso',
    ...
    #[ACL\Api(enable: true, title: 'Listar', description: 'Listar TipoCurso')]
    ...
    /** ****************************************************************************************** */
    /**
     * Cria o Recurso — TipoCurso.
     * Cria o Recurso — TipoCurso.
     */
    #[OA\Response(
        response: 201,
        description: 'Retorna novo recurso TipoCurso',
        content: new OA\JsonContent(
            properties: [
                new OA\Property(property: 'id', type: 'integer'),
                new OA\Property(property: 'tipo', type: 'string'),
    ...
    #[ACL\Api(enable: true, title: 'Criar', description: 'Criar TipoCurso')]
    ...
    /** ****************************************************************************************** */
    /**
     * Recupera o recurso — TipoCurso.
     * Recupera o recurso — TipoCurso.
     */
    #[OA\Parameter( name: 'id', description: 'Identificador do recurso', in: 'path')]
    #[OA\Response(
        response: 200,
        description: 'Retorna recurso TipoCurso',
        content: new OA\JsonContent(
            properties: [
                new OA\Property(property: 'id', type: 'integer'),
                new OA\Property(property: 'tipo', type: 'string'),
    ...
    #[ACL\Api(enable: true, title: 'Visualizar', description: 'Visualizar TipoCurso')]
    public function showAction(Request $request, mixed $id): Response
    {
        ...
        if (!$object)
            return $this->json(['status' => false, 'message' => 'TipoCurso não encontrado!'], 404);
    ...
    #[ACL\Api(enable: true, title: 'Editar', description: 'Editar TipoCurso')]
    ...
    */
    ...
    #[ACL\Api(enable: true, title: 'Deletar', description: 'Deletar TipoCurso')]
    public function deleteAction(mixed $id): Response
    {
        ...
        return $this->json(['status' => true, 'message' => 'TipoCurso removido com sucesso.'], 204);
    }
