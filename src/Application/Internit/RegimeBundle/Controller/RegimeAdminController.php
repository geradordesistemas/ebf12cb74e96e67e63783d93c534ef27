...
#[ACL\Admin(enable: true, title: 'Regime', description: 'Permissões modulo Regime')]
class RegimeAdminController extends BaseAdminController
{
    #[ACL\Admin(enable: true, title: 'Listar', description: 'Listar Regime')]
    ...
    #[ACL\Admin(enable: true, title: 'Visualizar', description: 'Visualizar Regime')]
    ...
    #[ACL\Admin(enable: true, title: 'Criar', description: 'Criar Regime')]
    ...
    #[ACL\Admin(enable: true, title: 'Editar', description: 'Editar Regime')]
    ...
    #[ACL\Admin(enable: true, title: 'Excluir', description: 'Excluir Regime')]
    ...
    #[ACL\Admin(enable: true, title: 'Excluir em Lote', description: 'Excluir Regime em lote')]
    ...
    #[ACL\Admin(enable: true, title: 'Exportar', description: 'Exportar Regime')]
    ...
    #[ACL\Admin(enable: true, title: 'Auditoria', description: 'Auditar Regime')]
