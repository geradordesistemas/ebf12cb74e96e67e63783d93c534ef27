...
use App\Application\Internit\RegimeBundle\Form\RegimeType;
...
#[Route('/web/regime', name: 'web_regime_', methods: ['GET'])]
#[ACL\Web(enable: true, title: 'Regime', description: 'Permissões do modulo Regime')]
class RegimeWebController extends BaseWebController
{
    ...
    {
        return "@ApplicationInternitRegime/regime/";
    }

    #[Route('', name: 'list', methods: ['GET'])]
    #[ACL\Web(enable: true, title: 'Listar', description: 'Lista Regime')]
    ...
    #[ACL\Web(enable: true, title: 'Criar', description: 'Cria Regime')]
    public function createAction(ManagerRegistry $doctrine, Request $request): Response
    {
        ...
        $data = new Regime();
        $form = $this->createForm(RegimeType::class, $data);
    ...
    #[ACL\Web(enable: true, title: 'Visualizar', description: 'Visualiza Regime')]
    ...
    #[ACL\Web(enable: true, title: 'Editar', description: 'Edita Regime')]
    ...
    #[ACL\Web(enable: true, title: 'Deletar', description: 'Deleta Regime')]
