<?php
namespace App\Application\Internit\PalavraChaveBundle\Admin;
...
final class PalavraChaveAdmin extends BaseAdmin
{

    public function toString(object $object): string
    {
        return $object instanceof PalavraChave ? $object->getId().''
    ...
    protected function configureFormFields(FormMapper $form): void
    {
        $form->tab('Geral');
            $form->with('Informações Gerais');
                ...
                $form->add('palavraChave',  TextType::class, [
                    'label' => 'Palavrachave',
                    'required' =>  true ,
    ...
    protected function configureDatagridFilters(DatagridMapper $datagrid): void
    {
        ...
        $datagrid->add('palavraChave', null, [
            'label' => 'Palavrachave',
        ]);
    ...
    protected function configureListFields(ListMapper $list): void
    {
        ...
        $list->addIdentifier('palavraChave', null, [
            'label' => 'Palavrachave',
