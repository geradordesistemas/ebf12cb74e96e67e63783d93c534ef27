...
use App\Application\Internit\PalavraChaveBundle\Form\PalavraChaveType;
...
class PalavraChaveWebController extends BaseWebController
{
    ...
    {
        return "@ApplicationInternitPalavraChave/palavrachave/";
    }
    ...
    public function createAction(ManagerRegistry $doctrine, Request $request): Response
    {
        ...
        $data = new PalavraChave();
        $form = $this->createForm(PalavraChaveType::class, $data);
