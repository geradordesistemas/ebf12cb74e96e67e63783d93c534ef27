...
#[ACL\Admin(enable: true, title: 'Curso', description: 'Permissões modulo Curso')]
class CursoAdminController extends BaseAdminController
{
    #[ACL\Admin(enable: true, title: 'Listar', description: 'Listar Curso')]
    ...
    #[ACL\Admin(enable: true, title: 'Visualizar', description: 'Visualizar Curso')]
    ...
    #[ACL\Admin(enable: true, title: 'Criar', description: 'Criar Curso')]
    ...
    #[ACL\Admin(enable: true, title: 'Editar', description: 'Editar Curso')]
    ...
    #[ACL\Admin(enable: true, title: 'Excluir', description: 'Excluir Curso')]
    ...
    #[ACL\Admin(enable: true, title: 'Excluir em Lote', description: 'Excluir Curso em lote')]
    ...
    #[ACL\Admin(enable: true, title: 'Exportar', description: 'Exportar Curso')]
    ...
    #[ACL\Admin(enable: true, title: 'Auditoria', description: 'Auditar Curso')]
