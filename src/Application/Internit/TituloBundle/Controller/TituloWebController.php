...
use App\Application\Internit\TituloBundle\Form\TituloType;
...
#[Route('/web/titulo', name: 'web_titulo_', methods: ['GET'])]
#[ACL\Web(enable: true, title: 'Titulo', description: 'Permissões do modulo Titulo')]
class TituloWebController extends BaseWebController
{
    ...
    {
        return "@ApplicationInternitTitulo/titulo/";
    }

    #[Route('', name: 'list', methods: ['GET'])]
    #[ACL\Web(enable: true, title: 'Listar', description: 'Lista Titulo')]
    ...
    #[ACL\Web(enable: true, title: 'Criar', description: 'Cria Titulo')]
    public function createAction(ManagerRegistry $doctrine, Request $request): Response
    {
        ...
        $data = new Titulo();
        $form = $this->createForm(TituloType::class, $data);
    ...
    #[ACL\Web(enable: true, title: 'Visualizar', description: 'Visualiza Titulo')]
    ...
    #[ACL\Web(enable: true, title: 'Editar', description: 'Edita Titulo')]
    ...
    #[ACL\Web(enable: true, title: 'Deletar', description: 'Deleta Titulo')]
