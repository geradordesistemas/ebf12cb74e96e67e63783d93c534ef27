...
#[Route('/api/titulo', name: 'api_titulo_')]
#[OA\Tag(name: 'Titulo')]
#[ACL\Api(enable: true, title: 'Titulo', description: 'Permissões do modulo Titulo')]
class TituloApiController extends BaseApiController
{
    ...
    /** ****************************************************************************************** */
    /**
     * Recupera a coleção de recursos — Titulo.
     * Recupera a coleção de recursos — Titulo.
    ...
    #[OA\Response(
        response: 200,
        description: 'Retorna Coleção de recursos Titulo',
    ...
    #[ACL\Api(enable: true, title: 'Listar', description: 'Listar Titulo')]
    ...
    /** ****************************************************************************************** */
    /**
     * Cria o Recurso — Titulo.
     * Cria o Recurso — Titulo.
     */
    #[OA\Response(
        response: 201,
        description: 'Retorna novo recurso Titulo',
        content: new OA\JsonContent(
            properties: [
                new OA\Property(property: 'id', type: 'integer'),
                new OA\Property(property: 'titulo', type: 'string'),
    ...
    #[ACL\Api(enable: true, title: 'Criar', description: 'Criar Titulo')]
    ...
    #[ACL\Api(enable: true, title: 'Visualizar', description: 'Visualizar Titulo')]
    public function showAction(Request $request, mixed $id): Response
    {
        ...
        if (!$object)
            return $this->json(['status' => false, 'message' => 'Titulo não encontrado!'], 404);
    ...
    #[ACL\Api(enable: true, title: 'Editar', description: 'Editar Titulo')]
    ...
    */
    ...
    #[ACL\Api(enable: true, title: 'Deletar', description: 'Deletar Titulo')]
    public function deleteAction(mixed $id): Response
    {
        ...
        return $this->json(['status' => true, 'message' => 'Titulo removido com sucesso.'], 204);
    }
