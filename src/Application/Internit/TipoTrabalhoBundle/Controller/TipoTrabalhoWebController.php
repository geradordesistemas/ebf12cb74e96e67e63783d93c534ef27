...
use App\Application\Internit\TipoTrabalhoBundle\Form\TipoTrabalhoType;
...
class TipoTrabalhoWebController extends BaseWebController
{
    ...
    {
        return "@ApplicationInternitTipoTrabalho/tipotrabalho/";
    }
    ...
    public function createAction(ManagerRegistry $doctrine, Request $request): Response
    {
        ...
        $data = new TipoTrabalho();
        $form = $this->createForm(TipoTrabalhoType::class, $data);
