<?php
namespace App\Application\Internit\TipoTrabalhoBundle\Admin;
...
final class TipoTrabalhoAdmin extends BaseAdmin
{

    public function toString(object $object): string
    {
        return $object instanceof TipoTrabalho ? $object->getId().''
