...
use App\Application\Internit\CorpoAcademicoBundle\Form\CorpoAcademicoType;
...
class CorpoAcademicoWebController extends BaseWebController
{
    ...
    {
        return "@ApplicationInternitCorpoAcademico/corpoacademico/";
    }
    ...
    public function createAction(ManagerRegistry $doctrine, Request $request): Response
    {
        ...
        $data = new CorpoAcademico();
        $form = $this->createForm(CorpoAcademicoType::class, $data);
