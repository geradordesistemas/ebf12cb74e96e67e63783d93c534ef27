...
use App\Application\Internit\AlunoBundle\Form\AlunoType;
...
#[Route('/web/aluno', name: 'web_aluno_', methods: ['GET'])]
#[ACL\Web(enable: true, title: 'Aluno', description: 'Permissões do modulo Aluno')]
class AlunoWebController extends BaseWebController
{
    ...
    {
        return "@ApplicationInternitAluno/aluno/";
    }

    #[Route('', name: 'list', methods: ['GET'])]
    #[ACL\Web(enable: true, title: 'Listar', description: 'Lista Aluno')]
    ...
    #[ACL\Web(enable: true, title: 'Criar', description: 'Cria Aluno')]
    public function createAction(ManagerRegistry $doctrine, Request $request): Response
    {
        ...
        $data = new Aluno();
        $form = $this->createForm(AlunoType::class, $data);
    ...
    #[ACL\Web(enable: true, title: 'Visualizar', description: 'Visualiza Aluno')]
    ...
    #[ACL\Web(enable: true, title: 'Editar', description: 'Edita Aluno')]
    ...
    #[ACL\Web(enable: true, title: 'Deletar', description: 'Deleta Aluno')]
