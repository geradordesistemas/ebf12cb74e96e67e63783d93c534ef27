...
#[ACL\Admin(enable: true, title: 'Aluno', description: 'Permissões modulo Aluno')]
class AlunoAdminController extends BaseAdminController
{
    #[ACL\Admin(enable: true, title: 'Listar', description: 'Listar Aluno')]
    ...
    #[ACL\Admin(enable: true, title: 'Visualizar', description: 'Visualizar Aluno')]
    ...
    #[ACL\Admin(enable: true, title: 'Criar', description: 'Criar Aluno')]
    ...
    #[ACL\Admin(enable: true, title: 'Editar', description: 'Editar Aluno')]
    ...
    #[ACL\Admin(enable: true, title: 'Excluir', description: 'Excluir Aluno')]
    ...
    #[ACL\Admin(enable: true, title: 'Excluir em Lote', description: 'Excluir Aluno em lote')]
    ...
    #[ACL\Admin(enable: true, title: 'Exportar', description: 'Exportar Aluno')]
    ...
    #[ACL\Admin(enable: true, title: 'Auditoria', description: 'Auditar Aluno')]
